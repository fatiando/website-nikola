...
# Default is ''
CONTENT_FOOTER = 'Contents &copy; {date} <a href="http://fatiando.org/people/uieda">{author}</a> - Powered by <a href="http://nikola.ralsina.com.ar">Nikola</a>'
